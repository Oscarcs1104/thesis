...
fusion. Predictor-only, no decoder, regression only -- for comparing Test
RMSE/NRMSE against the same dataset trained with training/train.py.
...
from thesis_model.train.train import (
    _target_range,
