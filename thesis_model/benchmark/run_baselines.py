...
Usage:
    ...
    python thesis_model/benchmark/run_baselines.py --datasets esol lipo --configs graph-only graph+lang --seeds 2025
    python thesis_model/benchmark/run_baselines.py --out results/fase2_baselines.csv
"""
...
from thesis_model.train.train import _target_range, load_predefined_datasets, resolve_predefined_split, run_single
