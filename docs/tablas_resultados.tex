...
\begin{table}[htbp]
  ...
  \begin{tabular}{@{}llrrrrc@{}}
    ...
    \midrule
    \multirow{2}{*}{ESOL}
      & desde cero    & 0,775 $\pm$ 0,073 & 0,572 & 0,853 &                    &     \\
      & preentrenado  & \textbf{0,640} $\pm$ 0,014 & 0,480 & 0,901 & $-0{,}134 \pm 0{,}061$ & 3/3 \\
    \midrule
    \multirow{2}{*}{FreeSolv}
      & desde cero    & 1,308 $\pm$ 0,041 & 0,970 & 0,859 &                    &     \\
      & preentrenado  & \textbf{0,903} $\pm$ 0,154 & 0,547 & 0,934 & $-0{,}406 \pm 0{,}194$ & 3/3 \\
    \midrule
    \multirow{2}{*}{Lipophilicity}
      & desde cero    & 0,849 $\pm$ 0,018 & 0,656 & 0,508 &                    &     \\
      & preentrenado  & \textbf{0,675} $\pm$ 0,019 & 0,519 & 0,689 & $-0{,}174 \pm 0{,}029$ & 3/3 \\
    \bottomrule
  \end{tabular}
  ...
  \begin{minipage}{0.92\textwidth}
    ...
    La dispersión de la columna $\Delta$ es la del contraste pareado y no la diferencia
    de las dispersiones de cada fila: al compartir partición las dos filas de cada
    conjunto, la varianza del sorteo se cancela al restar y no se imputa al error.
  \end{minipage}
\end{table}
...
\begin{table}[htbp]
  ...
  \begin{tabularx}{\textwidth}{@{}Xlrrr@{}}
    ...
    \dots\ \cite{}          & \dots & \dots & \dots & \dots \\
    \midrule
    \textbf{Este trabajo}   & Aleatoria, rehecha por semilla & \textbf{0,640} & \textbf{0,903} & \textbf{0,675} \\
    \bottomrule
  \end{tabularx}
\end{table}
% ---------------------------------------------------------------------
